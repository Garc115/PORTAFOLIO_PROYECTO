		...
		<div class="col-10">
			...
			<div class="card shadow p-3 mb-5 bg-body rounded">
				...
				<div class="card-body" style="padding:0em 2em 2em 2em">
					<form method="POST" action="{{ route('storeTownships') }}">
					@csrf

						<input type="hidden" id="modal" name="modal" value="0">

						<div class="row justify-content-center" style="margin-top:1em">
							<div class="col-6">
								<label for="township" class="form-label">Municipio</label>
								<input id="township"  name="township" type="text" class="form-control" value="{{ old('township') }}"
								 required autofocus>
							</div>
							<div class="col-6">
